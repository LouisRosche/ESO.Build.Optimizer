...
// Mock Characters (matches /characters endpoint response)
export const mockCharacters: Character[] = [
  {
    ...
    build: {
      ...
      skills_front: ['Molten Whip', 'Flames of Oblivion', 'Burning Embers'],
      skills_back: ['Unstable Wall of Fire', 'Cauterize', 'Barbed Trap'],
    },
  },
  {
    character_name: 'Shadowbane',
    ...
    build: {
      ...
      race: 'Khajiit',
      cp_level: 2100,
      sets: ['Pillar of Nirn', 'Arms of Relequen', 'Selene'],
      skills_front: ['Surprise Attack', 'Killer\'s Blade'],
      skills_back: ['Twisting Path', 'Leeching Strikes'],
    },
  },
  {
    character_name: 'Frost Warden',
    ...
    build: {
      ...
      race: 'Nord',
      cp_level: 2100,
      sets: ['Bahsei\'s Mania', 'Aegis Caller', 'Maw of the Infernal'],
      skills_front: [],
      skills_back: [],
    },
  },
  {
    ...
    build: {
      ...
      race: 'High Elf',
      cp_level: 1850,
      sets: ['Mother\'s Sorrow', 'Medusa', 'Slimecraw'],
      skills_front: [],
      skills_back: [],
    },
  },
...
// Mock DPS Trend Data (matches /analytics/dps-trend response)
export const mockDPSTrend: DPSTrendPoint[] = [
  { date: daysAgo(30), avg_dps: 65000, max_dps: 72000, run_count: 3 },
  { date: daysAgo(27), avg_dps: 68200, max_dps: 75100, run_count: 2 },
  { date: daysAgo(24), avg_dps: 67800, max_dps: 71400, run_count: 4 },
  { date: daysAgo(21), avg_dps: 71500, max_dps: 78200, run_count: 3 },
  { date: daysAgo(18), avg_dps: 73200, max_dps: 79800, run_count: 2 },
  { date: daysAgo(15), avg_dps: 72100, max_dps: 76500, run_count: 1 },
  { date: daysAgo(12), avg_dps: 76800, max_dps: 84300, run_count: 3 },
  { date: daysAgo(9), avg_dps: 78450, max_dps: 86200, run_count: 2 },
  { date: daysAgo(6), avg_dps: 82100, max_dps: 89500, run_count: 4 },
  { date: daysAgo(3), avg_dps: 79500, max_dps: 85600, run_count: 2 },
  { date: daysAgo(0), avg_dps: 85600, max_dps: 92100, run_count: 3 },
];

// Mock Percentile Trend Data (matches /analytics/percentile-trend response)
export const mockPercentileTrend: PercentileDataPoint[] = [
  { date: daysAgo(30), percentile: 52, dps: 65000, content_name: 'Lair of Maarselok' },
  { date: daysAgo(27), percentile: 58, dps: 68200, content_name: 'Rockgrove' },
  { date: daysAgo(24), percentile: 55, dps: 67800, content_name: 'Black Drake Villa' },
  { date: daysAgo(21), percentile: 63, dps: 71500, content_name: 'Rockgrove' },
  { date: daysAgo(18), percentile: 67, dps: 73200, content_name: 'Lair of Maarselok' },
  { date: daysAgo(15), percentile: 64, dps: 72100, content_name: 'Maelstrom Arena' },
  { date: daysAgo(12), percentile: 72, dps: 76800, content_name: 'Rockgrove' },
  { date: daysAgo(9), percentile: 76, dps: 78450, content_name: 'Black Drake Villa' },
  { date: daysAgo(6), percentile: 81, dps: 82100, content_name: 'Dreadsail Reef' },
  { date: daysAgo(3), percentile: 78, dps: 79500, content_name: 'Lair of Maarselok' },
  { date: daysAgo(0), percentile: 85, dps: 85600, content_name: 'Rockgrove' },
];

// Mock Buff Analysis (matches /analytics/buff-analysis response)
export const mockBuffAnalysis: BuffAnalysis[] = [
  { buff_name: 'Major Brutality', avg_uptime: 0.72, sample_count: 45, importance: 'high' },
  { buff_name: 'Major Savagery', avg_uptime: 0.88, sample_count: 45, importance: 'high' },
  { buff_name: 'Minor Force', avg_uptime: 0.65, sample_count: 38, importance: 'medium' },
  { buff_name: 'Major Berserk', avg_uptime: 0.45, sample_count: 32, importance: 'high' },
  { buff_name: 'Minor Berserk', avg_uptime: 0.82, sample_count: 28, importance: 'medium' },
  { buff_name: 'Major Resolve', avg_uptime: 0.91, sample_count: 20, importance: 'high' },
];
